...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/approval': RouteRecordInfo<'/approval', '/approval', Record<never, never>, Record<never, never>>,
    ...
    '/templates/rule': RouteRecordInfo<'/templates/rule', '/templates/rule', Record<never, never>, Record<never, never>>,
  }
}
